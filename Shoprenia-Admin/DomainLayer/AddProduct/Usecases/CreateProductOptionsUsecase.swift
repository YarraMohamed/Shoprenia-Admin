...
class CreateProductOptionsUsecase : CreateProductOptionsUsecaseProtocol {
    ...
    func excute(id : ID, productOptions : [OptionCreateInput], completionHandler: @escaping (Result<CreateProductOptionsMutation.Data.ProductOptionsCreate.Product, any Error>) -> Void) {
