...
protocol NetworkServiceProtocol {
    ...
    func createProduct(title : String, description : String, productType : String, vendor : String, completionHandler : @escaping (Result<CreateProductMutation.Data.ProductCreate.Product,Error>)->Void)
    ...
    func updateProductVariant(productID : ID , variants : [ProductVariantsBulkInput] , completionHandler : @escaping (Result<Bool,Error>)->Void)
    
    func setInventoryQuantity(inventoryQuantity : InventorySetQuantitiesInput , completionHandler : @escaping (Result<Bool,Error>)->Void)
}
