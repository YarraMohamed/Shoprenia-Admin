...
public class CreateFixedDiscountCodeMutation: GraphQLMutation {
  public static let operationName: String = "CreateFixedDiscountCode"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation CreateFixedDiscountCode($title: String!, $startsAt: DateTime!, $endsAt: DateTime!, $usageLimit: Int!, $code: String!, $discountAmount: Decimal!, $minimumSubtotal: Decimal!) { discountCodeBasicCreate( basicCodeDiscount: { title: $title startsAt: $startsAt endsAt: $endsAt usageLimit: $usageLimit customerSelection: { all: true } code: $code customerGets: { value: { discountAmount: { amount: $discountAmount } }, items: { all: true } } appliesOncePerCustomer: true minimumRequirement: { subtotal: { greaterThanOrEqualToSubtotal: $minimumSubtotal } } } ) { __typename userErrors { __typename field message } codeDiscountNode { __typename id codeDiscount { __typename ... on DiscountCodeBasic { title status startsAt endsAt codes(first: 1) { __typename nodes { __typename code } } } } } } }"#
    ))
  ...
  public struct Data: Shopify.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("discountCodeBasicCreate", DiscountCodeBasicCreate?.self, arguments: ["basicCodeDiscount": [
        ...
        "code": .variable("code"),
        "customerGets": [
          "value": ["discountAmount": ["amount": .variable("discountAmount")]],
          "items": ["all": true]
        ],
        "appliesOncePerCustomer": true,
        "minimumRequirement": ["subtotal": ["greaterThanOrEqualToSubtotal": .variable("minimumSubtotal")]]
      ]]),
    ] }
      ...
      public struct CodeDiscountNode: Shopify.SelectionSet {
        ...
        public struct CodeDiscount: Shopify.SelectionSet {
          ...
          public struct AsDiscountCodeBasic: Shopify.InlineFragment {
            ...
            public typealias RootEntityType = CreateFixedDiscountCodeMutation.Data.DiscountCodeBasicCreate.CodeDiscountNode.CodeDiscount
